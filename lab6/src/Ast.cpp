...
void BinaryExpr::typeCheck()
{
    ...
    if(expr1->getType()->isFunc()) expr1_type = ((FunctionType*)expr1->getSymPtr()-> getType())->getRetType();
    if(expr2->getType()->isFunc()) expr2_type = ((FunctionType*)expr2->getSymPtr()->getType())->getRetType();
